...
public class P83_List {
    ...
    public static void main(String[] args) {
        // ArrayList<DataType>  listName = new ArrayList<DataType>();
        // ArrayList <int> list1=new ArrayList<int>(); collection doesn't accept primitives
        ArrayList<Integer> list2= new ArrayList<>();
        // What is the size of this list ? == 0 (for now since we didn't add anything in our list)
